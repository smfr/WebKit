...
FETurbulenceSoftwareApplier::StitchData FETurbulenceSoftwareApplier::computeStitching(IntSize tileSize, float& baseFrequencyX, float& baseFrequencyY, bool stitchTiles)
{
    ...
    if (baseFrequencyX) {
        float lowFrequency = std::floorf(tileWidth * baseFrequencyX) / tileWidth;
        float highFrequency = std::ceilf(tileWidth * baseFrequencyX) / tileWidth;
    ...
    if (baseFrequencyY) {
        float lowFrequency = std::floorf(tileHeight * baseFrequencyY) / tileHeight;
        float highFrequency = std::ceilf(tileHeight * baseFrequencyY) / tileHeight;
